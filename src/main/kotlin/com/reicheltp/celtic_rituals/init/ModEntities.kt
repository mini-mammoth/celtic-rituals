...
object ModEntities {
    ...
    var WRAITH_ENTITY: EntityType<*>? =
        EntityType.Builder.create(WraithEntity.WraithFactory(), EntityClassification.MONSTER)
    ...
    var KOBOLD_ENTITY: EntityType<*>? =
        EntityType.Builder.create(KoboldEntity.KoboldFactory(), EntityClassification.MONSTER)
    ...
    fun registerEntitySpawnEggs(event: RegistryEvent.Register<Item>) {
        event.registry.registerAll(
            RegistrationHelper.createEntitySpawnEgg(
                WRAITH_ENTITY!!,
                0x000000,
                0xFFFFFF,
                "wraith_spawnegg"
      ...
      vararg biomes: Biome
        ...
        for (biome in biomes) {
            ...
            biome.getSpawns(classification)
                .add(Biome.SpawnListEntry(entityType, weight, minGroupCount, maxGroupCount))
        }
    }
}
