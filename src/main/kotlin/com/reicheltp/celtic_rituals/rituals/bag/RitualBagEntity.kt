...
class RitualBagEntity : ThrowableEntity, IRendersAsItem {
    companion object {
        private val ITEM = EntityDataManager
            .createKey(RitualBagEntity::class.java, DataSerializers.ITEMSTACK)
    }

    constructor(world: World) : super(ModEntities.RITUAL_BAG_ENTITY, world)
    constructor(packet: FMLPlayMessages.SpawnEntity, world: World) :
